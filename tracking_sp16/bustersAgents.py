...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for distance in livingGhostPositionDistributions:
            pos1 = pacmanPosition
            pos2 = distance.argMax()
            #find maze distance
            getDis = self.distancer.getDistance(pos1, pos2)
            if not closest or getDis < closest:
                closest = getDis
        ...
        for action in legal:
            ...
            #find maze distance
            getDis = self.distancer.getDistance(successorPosition, closestPosition)
            if not closest or getDis < closest:
                closest = getDis
                chooseAction = action
