    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            for newPos, prob in self.getPositionDistribution(gameState, oldPos).items():
                newDist[newPos] += prob * distribution[oldPos]
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        for position in positions:
            for index in range(numParticles/length):
        ...
        for particle in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                if ghostDistance is None:
                    ...
                    prob = prob * self.getObservationProb(ghostDistance, pacmanPosition, particle[i], jailPosition)
            distribution[particle] += prob
        distribution.normalize()
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                newPosition = distribution.sample()
